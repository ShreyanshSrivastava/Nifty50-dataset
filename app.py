...
st.title("\uc0\u55356 \u56814 \u55356 \u56819  NRI Real Estate Investment Analyzer")\
\
# --- Sidebar Inputs ---\
...
\
# --- Display ---\
st.subheader("\uc0\u55357 \u56522  Investment Summary")\
st.dataframe(df.style.format(\{\
    'Annual EMI': '\uc0\u8377 \{:,.0f\}',\
    'Annual Rent': '\uc0\u8377 \{:,.0f\}',\
    'Maintenance': '\uc0\u8377 \{:,.0f\}',\
    'Net Cashflow': '\uc0\u8377 \{:,.0f\}',\
    'Tax Savings': '\uc0\u8377 \{:,.0f\}',\
    'Net Benefit': '\uc0\u8377 \{:,.0f\}',\
    'Property Value': '\uc0\u8377 \{:,.0f\}',\
    'Net Benefit (USD)': '$\{:,.0f\}',\
    'Property Value (USD)': '$\{:,.0f\}'\
\}))\
\
st.markdown(f"### \uc0\u55357 \u56481  Internal Rate of Return (IRR): **\{irr * 100:.2f\}%**")\
st.markdown(f"### \uc0\u55357 \u56504  Net USD Sale Proceeds (post-tax): **$\{net_sale_proceeds_usd:,.0f\}**")\
\
# --- Download ---\
st.download_button(\
